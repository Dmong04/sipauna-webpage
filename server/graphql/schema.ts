...
type Query {
  ...
  professorsFull: [ProfessorDetail!]!
}
...
type Mutation {
  ...
  deleteSchedules(scheduleIds: [ID!]!): Boolean
  clearScheduleData: Boolean
  ...
  updateProfile(userId: ID!, fullname: String, email: String): User
  changePassword(userId: ID!, currentPassword: String!, newPassword: String!): Boolean

  createProfessor(fullName: String!, legalId: String!): ProfessorDetail
  updateProfessor(professorId: ID!, fullName: String, legalId: String): ProfessorDetail
